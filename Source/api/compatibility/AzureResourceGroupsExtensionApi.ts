...
import {
	Activity,
	AppResourceResolver,
	AzureHostExtensionApi,
	AzureResourceGroupsExtensionApi,
	LocalResourceProvider,
	PickAppResourceOptions,
...
export class InternalAzureResourceGroupsExtensionApi
	implements AzureHostExtensionApi, AzureResourceGroupsExtensionApi
{
	...
	#registerWorkspaceResourceProvider: (
		id: string,
		resolver: WorkspaceResourceProvider,
	) => Disposable;
	...
	public constructor(
		options: Omit<
			AzureHostExtensionApi,
			"tree" | "treeView" | "registerLocalResourceProvider"
		>,
	) {
	...
	public async pickAppResource<T extends AzExtTreeItem>(
		context: ITreeItemPickerContext,
		options?: PickAppResourceOptions,
	): Promise<T> {
	...
	public registerApplicationResourceResolver(
		id: string,
		resolver: AppResourceResolver,
	): Disposable {
	...
	public registerWorkspaceResourceProvider(
		id: string,
		resolver: WorkspaceResourceProvider,
	): Disposable {
	...
	public registerLocalResourceProvider(
		id: string,
