...
export class CompatibleWorkspaceResourceBranchDataProvider<
	TResource extends WorkspaceResource & v2WorkspaceResource,
> extends CompatibleBranchDataProviderBase<TResource, TResource> {
