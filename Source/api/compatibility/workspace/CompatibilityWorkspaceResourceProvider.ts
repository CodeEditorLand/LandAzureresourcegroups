...
import {
	WorkspaceResourceProvider as V2WorkspaceResourceProvider,
	WorkspaceResource,
} from "../../../../api/src/index";
import { CompatibleWorkspaceResourceBranchDataProvider } from "./CompatibleWorkspaceResourceBranchDataProvider";

export class CompatibilityWorkspaceResourceProvider
	implements V2WorkspaceResourceProvider
{
	constructor(
		private readonly resourceType: string,
		private readonly provider: WorkspaceResourceProvider,
		private readonly compatTreeDataProvider: CompatibleWorkspaceResourceBranchDataProvider<
			AzExtTreeItem & WorkspaceResource
		>,
	) {}
	...
	public async getResources(): Promise<WorkspaceResource[]> {
		...
		if (resources) {
			return resources.map((resource) => {
				return Object.assign<AzExtTreeItem, WorkspaceResource>(
					resource,
					{
