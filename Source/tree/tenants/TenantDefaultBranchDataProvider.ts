...
export class TenantDefaultBranchDataProvider
	implements BranchDataProvider<TenantResource, TenantResourceModel>
{
	getChildren(
		_element: TenantResourceModel,
	): vscode.ProviderResult<TenantResourceModel[]> {
		return [];
	}

	getResourceItem(
		element: TenantResource,
	): TenantResourceModel | Thenable<TenantResourceModel> {
		return new TenantResourceItem(element);
	}

	getTreeItem(
		element: TenantResourceModel,
