...
export class BranchDataItemCache {
	private readonly branchItemToResourceGroupsItemCache: Map<
		ResourceModelBase,
		ResourceGroupsItem
	> = new Map();
	...
	createOrGetItem<T extends BranchDataItemWrapper>(
		branchItem: ResourceModelBase,
		createItem: () => T,
	): T {
