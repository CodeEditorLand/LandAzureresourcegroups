...
export class GroupingItemFactory {
	...
	createResourceGroupGroupingItem(
		resourceGroup: AzureResource,
		options: GroupingItemOptions,
	): GroupingItem {
		return new ResourceGroupGroupingItem(
			resourceGroup,
			options,
			this.factoryOptions,
		);
	...
	createResourceTypeGroupingItem(
		resourceType: AzExtResourceType | string,
		options: GroupingItemOptions,
	): GroupingItem {
		return new ResourceTypeGroupingItem(
			resourceType,
			options,
			this.factoryOptions,
		);
