...
export class ResourceGroupGroupingItem extends GroupingItem {
	...
	constructor(
		readonly resourceGroup: AzureResource,
	...
	override getResourcesToDisplay(
...
export function isResourceGroupGroupingItem(
	groupingItem?: GroupingItem,
): groupingItem is ResourceGroupGroupingItem {
