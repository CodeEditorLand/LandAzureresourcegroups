...
export const azureExtensions: IAzExtMetadata[] = [
	{
		...
		tutorial: {
			label: localize(
				"deployServerless",
				"Create and deploy a serverless app",
			),
	...
	},
	{
		...
		label: "App Service",
		resourceTypes: [AzExtResourceType.AppServices],
		tutorial: {
	...
	},
	{
		...
		label: "Storage",
		resourceTypes: [AzExtResourceType.StorageAccounts],
		reportIssueCommandId: "azureStorage.reportIssue",
	},
	{
		name: "vscode-azurevirtualmachines",
		label: "Virtual Machines",
		resourceTypes: [AzExtResourceType.VirtualMachines],
	...
	},
	{
		...
		resourceTypes: [AzExtResourceType.ContainerAppsEnvironment],
	...
	},
	{
		...
		publisher: "vscjava",
		label: "Spring Apps",
		resourceTypes: [AzExtResourceType.SpringApps],
	...
	},
	{
		...
		label: "Logic Apps",
		resourceTypes: [AzExtResourceType.LogicApp],
		tutorial: {
	...
	},
	{
		...
		label: "Web PubSub",
		resourceTypes: [AzExtResourceType.WebPubSub],
