 ...
 */
export declare type AzureResourceBranchDataProvider<
	TModel extends AzureResourceModel,
> = BranchDataProvider<AzureResource, TModel>;
 ...
 */
export declare interface BranchDataProvider<
...
export declare function getAzureResourcesExtensionApi(
	extensionContext: vscode.ExtensionContext,
	apiVersionRange: "2.0.0",
	options?: GetApiOptions
): Promise<AzureResourcesExtensionApi>;

export declare function isWrapper(
	maybeWrapper: unknown
): maybeWrapper is Wrapper;
...
export declare type ResourceGroupsTreeDataProvider = Pick<
	vscode.TreeDataProvider<unknown>,
...
export declare interface ResourcesApi {
	 ...
	 */
	registerAzureResourceBranchDataProvider<TModel extends AzureResourceModel>(
		type: AzExtResourceType,
		provider: AzureResourceBranchDataProvider<TModel>
	): vscode.Disposable;
	/**
	 ...
	 * @returns A disposable that unregisters the provider.
	 */
	registerWorkspaceResourceBranchDataProvider<
		TModel extends WorkspaceResourceModel,
	>(
		type: WorkspaceResourceType,
		provider: WorkspaceResourceBranchDataProvider<TModel>
	): vscode.Disposable;
	/**
...
export declare type VSCodeRevealOptions = Parameters<
	vscode.TreeView<unknown>["reveal"]
>["1"];
 ...
 */
export declare type WorkspaceResourceBranchDataProvider<
	TModel extends WorkspaceResourceModel,
> = BranchDataProvider<WorkspaceResource, TModel>;
 ...
 */
export declare type WorkspaceResourceProvider = ResourceProvider<
	void,
	WorkspaceResource
>;
